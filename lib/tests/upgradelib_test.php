...
calendar,core_calendar|/calendar/view.php?view=month',
    ...
    /**
     * Test that clean up of calendar events is done as expected.
     *
     * @covers ::upgrade_calendar_clean_up_recursive_events
     */
    public function test_upgrade_calendar_clean_up_recursive_events() {
        global $CFG, $DB;
        $this->resetAfterTest();
        $this->setAdminUser();
        $generator = $this->getDataGenerator();
        ...
        $this->assertEquals(15, count($shouldbedeleted));
        $this->assertEquals(12, count($shouldremain));
    ...
    /**
     * Test that UUIDs are assigned to all calendar events with empty ones.
     *
     * @covers ::upgrade_calendar_ensure_uuid_for_all_events
     */
    public function test_upgrade_calendar_ensure_uuid_for_all_events() {
        global $DB;
        $this->resetAfterTest();
        $this->setAdminUser();
        $generator = $this->getDataGenerator();
        ...
        $hostname = "foo.bar";
        $num = upgrade_calendar_ensure_uuid_for_all_events($hostname);
