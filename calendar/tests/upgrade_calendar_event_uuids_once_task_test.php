...
use core_calendar\task\upgrade_calendar_event_uuids_once_task;
use dml_exception;
...
/**
 * Tests for the {@see upgrade_calendar_event_uuids_once_task} class.
 *
 * @package    core_calendar
 * @copyright  2024 Daniil Fajnberg
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class upgrade_calendar_event_uuids_once_task_test extends advanced_testcase {
    /**
     * Tests that executing the task calls the expected cleanup methods and disables itself.
     *
     * @covers upgrade_calendar_event_uuids_once_task::execute
    ...
    public function test_execute(): void {
        ...
        $mock_task = $this->getMockBuilder(upgrade_calendar_event_uuids_once_task::class)
                          ->onlyMethods(['clean_up_recursive_events', 'ensure_uuid_for_all_events', 'disable'])
                          ->getMock();
        ...
        $this->assertStringContainsString('finished successfully and disabled itself', $output);
    }

    /**
     * Tests that clean up of calendar events is done as expected.
     *
     * @covers upgrade_calendar_event_uuids_once_task::clean_up_recursive_events
    ...
    public function test_clean_up_recursive_events(): void {
        ...
        $task = new upgrade_calendar_event_uuids_once_task();
     ...
     *
     * @covers upgrade_calendar_event_uuids_once_task::ensure_uuid_for_all_events
     * @throws coding_exception
     * @throws dml_exception
     */
