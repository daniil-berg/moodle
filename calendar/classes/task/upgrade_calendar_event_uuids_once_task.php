 ...
 *
 * This task is designed in place of an upgrade script and is intended to do the work only once and then disable itself.
 *
 * Check the documentation of {@see upgrade_calendar_event_uuids_once_task::clean_up_recursive_events} and
 * {@see upgrade_calendar_event_uuids_once_task::ensure_uuid_for_all_events} to see what exactly it does.
 *
 * @copyright 2024 Daniil Fajnberg
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class upgrade_calendar_event_uuids_once_task extends scheduled_task {

    /**
     * @inheritDoc
     */
    public function get_name(): string {
        return 'Task for upgrading calendar event UUIDs and cleanup of recursive imports';
    }
    ...
    public function execute(): void {
        ...
        $this->disable();
        mtrace(self::class . " finished successfully and disabled itself.");
    }
